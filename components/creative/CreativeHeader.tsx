...
export function CreativeHeader({ total, search, onSearchChange, assignedToMe, onAssignedToMeChange }: CreativeHeaderProps) {
  return (
    <div className="flex items-center justify-between gap-4 flex-wrap">
      <div>
        <h1 className="text-xl font-bold text-gray-900">Creative Queue</h1>
        <p className="text-sm text-gray-500">{total} orders assigned to creative</p>
      </div>
